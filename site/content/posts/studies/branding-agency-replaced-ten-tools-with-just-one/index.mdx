...
You can play with this notebok in Python [here](https://github.com/danielsobrado/notebooks_invest/blob/master/cycles/Benner%20Cycle.ipynb) and see the results of the Benner Cycle in action. 

![Notebook in Python](https://i.imgur.com/Y4ixLyd.png)
