...
These values represent the average returns for each day in July. It's quite notable that July 1st is, on average, the strongest day of the year in terms of returns, with a value of 71%. Please note, however, that the 4th of July is a holiday, so the market is closed.
