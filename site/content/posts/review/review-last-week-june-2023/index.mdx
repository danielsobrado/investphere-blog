...
* Insiders significantly increase U.S. stock sales.
...
![Imgur](https://i.imgur.com/Jn11SXd.png)

Returns of the main sectors for the month of June:

![Imgur](https://i.imgur.com/i6nAWCG.png)

The Year to day performance by sector is:

![Imgur](https://i.imgur.com/QL9GOqe.png)
